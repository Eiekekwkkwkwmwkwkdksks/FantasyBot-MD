...
if wget -q https://github.com/diegojadibot/FantasyBot-MD/tree/main/musicSH/"$random_mp3"; then
...
echo -e "\033[01;32m\033[01mIniciando FantasyBot-MD by diegojadibot\n\033[0m"
npm start
